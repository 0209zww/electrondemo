<template>
    <div class="login" style="overflow:hidden;">
        ...
        <main>
            <!-- 顶部背景图 -->
            <div class="bg">
                <img style="" src="../assets/login.png" />
            </div>
            <!-- 登录表单组件 -->
            <div class="body">
        ...
        <footer class="footer">
            ...
            <div class="zczh" @click="zc">登录</div>
            <div>
                <span title="二维码登录" class="iconfont icon-yanxierweima"></span>
            </div>
        </footer>
    </div>
</template>
...
export default {
    ...
    created() {
        remote.getCurrentWindow().setSize(482, 551)
     },
    methods: {
        close() {
            // 只是关闭窗口，软件不退出
